...
describe "Numeral::V1::Transactions::TransactionId#get" do
  # it "render transaction" do
  #   transactions_list = Numeral::V1::Transactions.get_list(uri_opt: {limit: "1"})
  #   id = transactions_list["records"].first["id"]
  #   res = Numeral::V1::Transactions::TransactionId.get(id)
